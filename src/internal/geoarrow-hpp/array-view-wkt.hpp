...
class FixedWidthWKTArrayView: public ArrayView {
public:
    FixedWidthWKTArrayView(const struct ArrowSchema* schema): ArrayView(schema) {}
    ...
    Handler::Result read_features(Handler* handler) {
        return internal::read_features_templ<FixedWidthWKTArrayView>(*this, handler);
    }

    Handler::Result read_feature(Handler* handler, int64_t offset) {
        return internal::read_feature_templ<FixedWidthWKTArrayView>(*this, offset, handler);
    }
