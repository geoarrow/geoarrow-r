...
to **arrow** functions directly after
[`library(geoarrow)`](https://geoarrow.org/geoarrow-r/) or
[`requireNamespace("geoarrow")`](https://geoarrow.org/geoarrow-r/) has
been called.
...
The entry point to creating arrays is
