...
```{r}
points <- geoarrow_create_narrow_from_buffers(
  wk::wkt(c("POINT (30 10)", "POINT (40 30)"))
)

linestrings <- geoarrow_create_narrow_from_buffers(
  wk::wkt(
    c(
...
polygons <- geoarrow_create_narrow_from_buffers(
  wk::wkt(
    c(
...
multipoints <- geoarrow_create_narrow_from_buffers(
  wk::wkt(c("MULTIPOINT (0 1, 2 3)", "MULTIPOINT (0 0, 3 8)"))
)

multilinestrings <- geoarrow_create_narrow_from_buffers(
  wk::wkt(
    c(
...
multipolygons <- geoarrow_create_narrow_from_buffers(
  wk::wkt(
    c(
      "MULTIPOLYGON (
...
#include <cpp11.hpp>
#include "narrow.h"
#include "../../src/internal/geoarrow-hpp/factory.hpp"
...
#include <cpp11.hpp>
#include "narrow.h"
#include "../../src/internal/geoarrow-hpp/meta.hpp"
...
points_struct <- geoarrow_create_narrow_from_buffers(
  points,
...
with_crs <- geoarrow_create_narrow_from_buffers(
