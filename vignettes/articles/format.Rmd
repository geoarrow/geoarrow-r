...
- Multipoint geometries have an `ARROW:extension:name` of "geoarrow.collectionpoint" and must contain a child named "points" with the "geoarrow.point" extension type.
- Multilinestring geometries have an `ARROW:extension:name` of "geoarrow.collectionlinestring" and must contain a child named "linestrings" with the "geoarrow.linestring" extension type.
- Multipolygon geometries have an `ARROW:extension:name` of "geoarrow.collectionpolygon" and must contain a child named "polygons" with the "geoarrow.polygon" extension type.
