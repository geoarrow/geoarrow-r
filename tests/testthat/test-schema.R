...
test_that("extension schemas can be created", {
  ...
  expect_s3_class(geoarrow_schema_point_float32(), "carrow_schema")
  ...
  expect_s3_class(geoarrow_schema_flat_linestring(), "carrow_schema")
  expect_s3_class(geoarrow_schema_flat_polygon(), "carrow_schema")
  expect_s3_class(geoarrow_schema_flat_multi(geoarrow_schema_point()), "carrow_schema")
})
