...
test_that("extension schemas can be created", {
  ...
  expect_s3_class(geoarrow_schema_dense_geometrycollection(list(geoarrow_schema_point())), "narrow_schema")
  expect_s3_class(geoarrow_schema_sparse_geometrycollection(list(geoarrow_schema_point())), "narrow_schema")
})
